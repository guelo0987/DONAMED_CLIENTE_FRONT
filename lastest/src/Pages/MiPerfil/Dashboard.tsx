                        ...
                        <div className="relative w-full flex flex-col">
                            ...
                            >
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-[#718096] text-[13px] sm:text-[15px] leading-[140%]">
                            ...
                            <div className="w-full xl:w-[527px] bg-[#F0F0F0]/45 rounded-[17px] p-6">
                                ...
                                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 text-center sm:text-left">
                                    <div className="w-[80px] h-[80px] rounded-[12px] overflow-hidden bg-[#C4C4C4] border-[0.5px] border-[#DCD7D7] flex-shrink-0">
                                        <img src="/assets/imagen_usuario.png" alt="User" className="w-full h-full object-cover" />
                                    </div>
                                    <div className="flex flex-col gap-2">
                                        <h4 className="text-[#2D3748] text-xl sm:text-2xl font-normal">Maria Concepcion</h4>
                                        <div className="flex flex-col gap-1 text-[#2D3748] text-sm sm:text-base font-medium">
                                            <p><span className="text-[#2D3748]">Nombre:</span> Maria</p>
                                            <p><span className="text-[#2D3748]">Apellido:</span> Concepción</p>
                                            <p><span className="text-[#2D3748]">Teléfono:</span> 809-693-8956</p>
                                            <p><span className="text-[#2D3748]">Correo:</span> mariacon@ejemplo.com</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
