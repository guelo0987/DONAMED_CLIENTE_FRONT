...
export const HeroSection = () => {
    ...
    return (
        <section className="relative z-10 w-full max-w-[1060px] mx-auto px-4 sm:px-5 md:px-6 lg:px-7 pb-10 lg:pb-16 overflow-visible">
            ...
            <div className="relative z-20 -mt-12 sm:-mt-16 lg:-mt-16 w-full max-w-[860px] mx-auto lg:ml-0 px-2 sm:px-3 lg:px-0">
